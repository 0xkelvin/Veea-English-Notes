    ...
    return Column(
      ...
      children: [
        ...
        if (widgetProvider.isWidgetEnabled) ...[
          ...
          const SizedBox(height: PixelMetrics.space3),
          _ToggleTile(
            title: 'PRONOUNCE ON WIDGET TAP',
            subtitle: 'Speaks the English word aloud and rotates to next word when widget is clicked',
            enabled: widgetProvider.pronounceOnTap,
            onChanged: (value) => widgetProvider.setPronounceOnTap(value),
          ),
          const SizedBox(height: PixelMetrics.space3),
          _ToggleTile(
