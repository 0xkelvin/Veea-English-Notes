            ...
            VStack(alignment: .leading, spacing: 6) {
                HStack {
                    Text("WORD OF THE DAY")
                        ...
                        .foregroundColor(Color(red: 0.41, green: 0.42, blue: 0.37))
                    Spacer()
...
struct WordOfDayWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .description("Displays your daily review words, IPA pronunciation, and streak badge.")
