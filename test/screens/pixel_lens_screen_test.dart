...
void main() {
  ...
  testWidgets(
    'PixelLensScreen displays camera and gallery buttons and token HUD',
    (tester) async {
  ...
  testWidgets(
    'Non-English words and symbols are grayed down and have capture disabled',
    (tester) async {
      await tester.pumpWidget(buildApp());
      await settle(tester);
  ...
  testWidgets('PixelLensScreen does not overflow on narrow screens', (
    tester,
  ) async {
